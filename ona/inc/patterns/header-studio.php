...
return array(
	...
	'content'    => '
			...
			<!-- wp:navigation {"textColor":"light","overlayBackgroundColor":"light","overlayTextColor":"dark","className":"ona-sm-down-justify-content-end is-style-ona-tablet-justify-center","style":{"typography":{"fontSize":"1.125rem"}},"layout":{"type":"flex","orientation":"horizontal"}} -->
			...
			<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="#newsletter" style="padding-top:var(--wp--preset--spacing--30);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--40)">' . esc_html__( 'Get in Touch', 'ona' ) . '</a></div>
			<!-- /wp:button --></div>
			<!-- /wp:buttons --></div>
			<!-- /wp:group --></div>
			<!-- /wp:column --></div>
