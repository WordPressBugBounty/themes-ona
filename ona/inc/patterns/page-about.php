...
return array(
	...
	'content'    => '
			...
			<!-- wp:heading {"level":2,"className":"is-style-ona-alt-font","fontSize":"x-large"} -->
			<h2 class="wp-block-heading is-style-ona-alt-font has-x-large-font-size">' . esc_html__( 'Living my best life', 'ona' ) . '</h2>
			<!-- /wp:heading -->

			<!-- wp:heading {"level":1,"style":{"spacing":{"margin":{"right":"15%"}}}} -->
			<h1 id="i-am-a-lifestyle-and-fashion-blogger-a-person-who-enjoys-travel" style="margin-right:15%">' . esc_html__( 'I am a lifestyle and fashion blogger, a person who enjoys travel.', 'ona' ) . '</h1>
			<!-- /wp:heading --></div>
			<!-- /wp:column --></div>
			<!-- /wp:columns --></div>
			<!-- /wp:group -->
			...
			<p class="has-text-align-center has-foreground-color has-text-color has-medium-large-font-size" style="line-height:1.3"><em>' . esc_html__( '“To us, a healthy woman is confident in her own skin, flaws and all.”', 'ona' ) . '</em></p>
			<!-- /wp:paragraph -->
			...
			' . esc_html__( 'I Love working with people who find joy in the little things', 'ona' ) . '
			</h2>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"align":"center"} -->
			<p class="has-text-align-center">' . esc_html__( 'Some blogs focus more on fashion advice, featuring how-to articles for the lay reader. Articles discuss clothing fit, the matching and complementing of colors, and other information on clothes wearing and care along with prescriptive advice.', 'ona' ) . '</p>
			<!-- /wp:paragraph --></div>
			<!-- /wp:group --></div>
			<!-- /wp:column -->
			...
			<h3 class="has-text-align-center has-large-font-size" id="99">' . esc_html__( '99', 'ona' ) . '</h3>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"align":"center"} -->
			<p class="has-text-align-center">' . esc_html__( 'Houses sold in 2021 for my clients', 'ona' ) . '</p>
			<!-- /wp:paragraph --></div>
			<!-- /wp:group --></div>
			<!-- /wp:column -->
			...
			<div class="wp-block-column" style="padding-top:40px;padding-right:40px;padding-bottom:40px;padding-left:40px"><!-- wp:group -->
			<div class="wp-block-group"><!-- wp:heading {"textAlign":"center","level":3,"fontSize":"large"} -->
			<h3 class="has-text-align-center has-large-font-size" id="99">' . esc_html__( '1,500+', 'ona' ) . '</h3>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"align":"center"} -->
			<p class="has-text-align-center">' . esc_html__( 'Cups of coffee drank in courtrooms in 2021', 'ona' ) . '</p>
			<!-- /wp:paragraph --></div>
			<!-- /wp:group --></div>
			<!-- /wp:column -->
			...
			<div class="wp-block-column" style="padding-top:40px;padding-right:40px;padding-bottom:40px;padding-left:40px"><!-- wp:group -->
			<div class="wp-block-group"><!-- wp:heading {"textAlign":"center","level":3,"fontSize":"large"} -->
			<h3 class="has-text-align-center has-large-font-size" id="99">' . esc_html__( '700K', 'ona' ) . '</h3>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"align":"center"} -->
			<p class="has-text-align-center">' . esc_html__( 'Profits gained for my clients and money', 'ona' ) . '</p>
			<!-- /wp:paragraph --></div>
			<!-- /wp:group --></div>
			<!-- /wp:column --></div>
			<!-- /wp:columns -->
