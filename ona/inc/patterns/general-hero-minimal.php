...
return array(
	...
	'content'    => '
			...
			<h1 class="has-text-align-center has-large-font-size" id="hey-i-m-ona-and-this-is-my-travel-journal">' . esc_html__( 'Hey, I’m Ona, and this is my travel journal', 'ona' ) . '</h1>
			<!-- /wp:heading --></div>
			<!-- /wp:group --></div></div>
			<!-- /wp:media-text --></div>
			<!-- /wp:group -->',
