...
return array(
	...
	'content'    => '
			...
			<!-- wp:group {"style":{"spacing":{"padding":{"top":"15%","right":"20%","bottom":"15%","left":"20%"}}},"backgroundColor":"background-light"} -->
			...
			<h2 class="has-large-font-size" id="my-travel-gear" style="line-height:1.2">' . esc_html__( 'My Travel Gear', 'ona' ) . '</h2>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.4"}},"fontSize":"medium"} -->
			<p class="has-medium-font-size" style="line-height:1.4">' . esc_html__( 'Some blogs focus more on fashion advice, featuring how-to articles for the lay reader.', 'ona' ) . '</p>
			<!-- /wp:paragraph -->

			<!-- wp:paragraph -->
			<p>' . esc_html__( 'Some blogs focus more on fashion advice, featuring how-to articles for the lay reader. Articles discuss clothing fit, the matching and complementing of colors, and other information on clothes wearing and care along with prescriptive advice.', 'ona' ) . '</p>
			<!-- /wp:paragraph -->
			...
			<!-- wp:heading {"className":"is-style-ona-alt-font"} -->
			<h2 class="wp-block-heading is-style-ona-alt-font">' . esc_html__( 'Joebyragpa', 'ona' ) . '</h2>
			<!-- /wp:heading -->
