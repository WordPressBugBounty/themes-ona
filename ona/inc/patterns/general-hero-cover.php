...
return array(
	...
	'content'    => '			
			<!-- wp:cover {"url":"' . esc_url( get_template_directory_uri() ) . '/assets/img/ona_hero_cover.webp","id":10,"hasParallax":true,"dimRatio":30,"customOverlayColor":"#111111","minHeight":67,"minHeightUnit":"vh","contentPosition":"center center","isDark":false,"style":{"color":[]},"className":"ona-hero"} -->
